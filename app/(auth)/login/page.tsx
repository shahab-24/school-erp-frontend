  ...
  return (
    <>
      <style>{`
        ...
        .brand-chip { font-family:"JetBrains Mono",monospace; font-size:10.5px; color:var(--text-muted); background:var(--accent-soft); border:1px solid rgba(245,158,11,0.12); border-radius:5px; padding:2px 7px; }
        ...
        .toggle-pw { position:absolute; right:12px; background:none; border:none; cursor:pointer; color:var(--text-muted); padding:4px; display:flex; border-radius:4px; transition:color var(--transition); }
        .toggle-pw:hover { color:var(--accent); }
        .forgot-link { align-self:flex-end; font-size:12px; color:var(--accent); text-decoration:none; font-weight:500; margin-top:-4px; }
        ...
        .login-btn:hover:not(:disabled) { background:var(--accent-hover); box-shadow:0 6px 28px rgba(245,158,11,0.45); transform:translateY(-1px); }
        .login-btn:disabled { opacity:0.7; cursor:not-allowed; }
        .login-spinner { width:16px; height:16px; border:2px solid rgba(0,0,0,0.2); border-top-color:#0B0F1A; border-radius:50%; animation:spin 0.7s linear infinite; }
        ...
        .role-pill { flex:1; min-width:80px; background:var(--bg-input); border:1px solid var(--border); border-radius:6px; padding:7px 9px; display:flex; align-items:center; gap:6px; transition:border-color var(--transition),background var(--transition); }
